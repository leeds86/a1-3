...
| **보너스 2** | **UX & 인터랙션 고도화 (마이크로 인터랙션)** | • **FAQ `+` 회전 아코디언**: 45도 회전 및 부드러운 슬라이드 인터랙션<br>• **로딩 펄스 & 지연 안내 전환**: 분석 중 펄스 애니메이션 및 3.5초 후 안내 문구 자동 전환<br>• **플로팅 토스트 팝업**: 복사, 저장, 조회 시 실시간 알림 피드백<br>• **글래스 카드 호버 리프트**: 마우스 인터랙션 피드백 |
