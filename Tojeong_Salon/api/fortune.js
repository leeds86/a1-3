...
**💼 일과 성취**
(업무, 학업, 목표 달성에 관한 흐름과 실천 조언을 3~4문장으로 작성)

**💕 관계와 인연**
(가족, 친구, 동료 및 새로운 인연에 관한 흐름과 관계 조언을 3~4문장으로 작성)

**💰 재물과 흐름**
(수입과 지출의 흐름, 계획적인 재정 관리에 관한 조언을 3~4문장으로 작성)

**🌿 건강과 에너지**
(생활 습관과 컨디션 관리에 관한 현실적인 조언을 2~3문장으로 작성)
...
**✨ 토정 선생의 한마디**
(${targetYear}를 준비하는 데 도움이 되는 품위 있고 따뜻한 조언을 2문장으로 작성)

[주의사항]
- 부정적인 표현은 부드럽게 순화
- 구체적이고 실용적인 조언 포함
- 읽기 쉽고 신뢰감 있는 상담 리포트 문체로 작성
- 근거 없이 특정 사건, 질병, 금전적 결과를 단정하지 말 것
- 전체 분량은 1,000~1,300자 내외로 작성
`;
